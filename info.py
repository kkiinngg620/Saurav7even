...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<b>Title:</b> <code>{file_caption}</code><b>@sauravMkv</b>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "<b>Title:</b> <code>{file_caption}</code>")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b> \n<b>‌‌‌‌IMDb Data by: @sauravMkv </b> \n\n<b>🍿 Title: {title}</b>\n<b>🌟 Rating : {rating}/10</b>\n<b>🎭 Genres: {genres}</b>\n<b>📆 Year: {year}</b>\n<b>⏰ Duration : {runtime} minutes</b>\n\n<b>♥️ Please Share Us ♥️</b>")
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', '-1001841514652'))
...
DOWNLOAD_TEXT_URL = "https://sauravMkv"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/sauravMkv"
