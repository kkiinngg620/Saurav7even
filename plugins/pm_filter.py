...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [   
	    InlineKeyboardButton(text='⚡Join Backup Channel⚡', url=f'https://t.me/sauravMkv')
        ]   
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📥 Join Backup Channel 📥', url=f'https://t.me/sauravMkv')
            ],[
